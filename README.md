...
- Pipeline, readiness checker, application packet builder, submission planner, and Automation Unit currently validate packages and write reports only; they do not apply to jobs.
